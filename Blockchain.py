...
class Blockchain:
	def __init__(self):
		...
		self.nodes = set()
		# Set is used to ensure that no matter how many times we add a specific node, it appears exactly once
	...
	def register_node(self,address):
		...
		:param address: <str> Address of node. Eg. 'http://192.168.2.5:5000'
		:return: None
		"""
	...
	def hash(block):
		'''
		Crates a SHA-256 hash of a block
